package com.salesianostriana.dam.validations.errores;

import com.salesianostriana.dam.validations.errores.modelo.ApiError;
import com.salesianostriana.dam.validations.errores.modelo.ApiSubError;
import com.salesianostriana.dam.validations.errores.modelo.ApiValidationSubError;
...
public class GlobalRestControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleConstrintViolationException(ConstraintViolationException ex, WebRequest request) {
        return buildApiErrorWithSubError(HttpStatus.BAD_REQUEST,
                "Errores en la validación de los datos! Revise el contenido de los campos que se indican a continuación:",
                request,
